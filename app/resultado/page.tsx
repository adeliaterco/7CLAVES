...
export default function ResultPageOptimized() {
  ...
  const reloadVturbScript = () => {
    ...
    script.src = "https://scripts.converteai.net/498be6ac-2d19-4386-aba2-c11c84449107/players/68bb9e4fc820ef16d50805b6/v4/player.js"
    script.async = true
            ...
            <div className="w-full max-w-4xl">
              <div className="relative bg-black rounded-2xl p-2 sm:p-4 border-4 border-orange-500 shadow-2xl">
                ...
                <div className="relative z-10">
                  {/* VTURB PLAYER */}
                  <vturb-smartplayer 
                    id="vid-68bb9e4fc820ef16d50805b6" 
